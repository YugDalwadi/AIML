...
source_pad, target_pad = helpers.loadPickle("source_pad", "target_pad")
...
source_enc = clean_funcs.replaceUnk(source_pad, source_freq)
target_enc = clean_funcs.replaceUnk(target_pad, target_freq)
